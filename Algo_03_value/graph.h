...
class Edge
{												//edge has 4 features edge index,from ,to, egde label
public:
	unsigned eid;
	unsigned from;
	unsigned to;
...
class Vertex
{
public:											//Vertex has 4 features vertex label, degree of vertex ,vector of all edges from yhat vertex 
	int vlabel;
	unsigned degree;							// a pointer to the vector of edges 
	unsigned* elabs;
	vector<Edge> edges;	
